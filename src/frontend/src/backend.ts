...
import type { ExternalBlob as _ExternalBlob, Order as _Order, Product as _Product, ProductInput as _ProductInput, UserProfile as _UserProfile, UserRole as _UserRole, Vendor as _Vendor, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProductWithoutVendor(arg0: ProductInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProductWithoutVendor(await to_candid_ProductInput_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkOut(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getProductsByVendorId(arg0: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByVendorId(arg0);
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductsFromAdmin(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsFromAdmin();
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingProducts(): Promise<Array<TrendingProduct>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Vendor]): Vendor | null {
    return value.length === 0 ? null : value[0];
}
...
async function to_candid_ProductInput_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductInput): Promise<_ProductInput> {
